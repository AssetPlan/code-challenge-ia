### **PRD: Agente Conversacional para Clínica Veterinaria Virtual "VetCare AI"**

**Documento:** Product Requirements Document (PRD)
**Proyecto:** Desafío de Contratación - Ingeniero de IA
**Fecha:** 27 de noviembre de 2025
**Autor:** [Tu Nombre/Nombre de la Empresa]
...
*   **Base de Conocimientos:** Se te proporcionará una carpeta llamada `info-cuidados-mascotas` que contiene varios documentos de texto. El agente debe usar estos documentos como su única fuente de verdad para responder a las preguntas.
